...
public class DAA_Writer2 {
	...
	public DAA_Writer2(File out, File samFile, DAA_Reader daaReader) {
		this.out = out;
	...
	public void finish() {
		try {
			...
			// System.out.println("AliBlock: " + (out.length() - 2448) + " " + aliBlockSize.get());
			...
			// System.out.println("RefBlock: " + (out.length() - 2448 - aliBlockSize.get()));
